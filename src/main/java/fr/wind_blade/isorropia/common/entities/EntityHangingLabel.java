...
public class EntityHangingLabel extends EntityHanging implements IEntityAdditionalSpawnData {
    ...
    public void playPlaceSound() {
        ...
        playSound(state.getBlock().getSoundType(state, this.world, hangingBlock, (Entity) this).getHitSound(), 1.5F, 1.0F);
    }
    ...
    public void readSpawnData(ByteBuf additionalData) {
        updateFacingWithBoundingBox(EnumFacing.byHorizontalIndex(additionalData.readInt()));
