...
public class SlotMorphicFingers extends Slot
{
    private InventoryCrafting craftMatrix;
    private EntityPlayer player;
    private int amountCrafted;
    private TileFinger tile;
    
    public SlotMorphicFingers(TileFinger te, EntityPlayer par1EntityPlayer, InventoryCrafting inventory, IInventory par3IInventory, int par4, int par5, int par6) {
