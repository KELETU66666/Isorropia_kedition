...
public class IsorropiaHelper {
    ...
    public static NBTTagCompound livingToNBT(EntityLiving living) {
        ...
        // Remove from all entity lists and chunk
        if (living.addedToChunk && living.world instanceof WorldServer) {
            WorldServer world = (WorldServer) living.world;
            world.getChunk(living.chunkCoordX, living.chunkCoordZ).removeEntity(living);
        }
    ...
    public static NBTTagCompound livingBaseToStatue(EntityLivingBase base) {
        ...
        if (base instanceof EntityLiving) {
            ...
            NBTUtil.writeGameProfile(profile, ((EntityPlayer) base).getGameProfile());
    ...
    public static void profileToStatueData(NBTTagCompound nbt, GameProfile profile) {
        ...
        NBTUtil.writeGameProfile(data, profile);
