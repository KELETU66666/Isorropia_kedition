...
public class EntityEventHandler
{
    ...
    /*  80 */   private static final Random randy = new Random();
    ...
    public void onAttachCapability(AttachCapabilitiesEvent<Entity> event) {
        ...
        if (entity instanceof EntityLiving) {
            event.addCapability(new ResourceLocation("isorropia", "LIVING_CAPABILITY"), new LivingCapability((EntityLiving)event
/* 112 */             .getObject()));
        } else if (entity instanceof EntityLivingBase) {
            /* 114 */       event.addCapability(new ResourceLocation("isorropia", "LIVING_BASE_CAPABILITY"), new LivingBaseCapability((EntityLivingBase)event
/* 115 */             .getObject()));
        }
    }
...
/* 129 */       .getItem()).showNodes(stack, event.getEntityLiving())) {
            ...
            /* 137 */       Common.INSTANCE.sendTo(new LensRemoveMessage(lens, lens2), (EntityPlayerMP)event.getEntityLiving());
        }
    }
...
/* 147 */       .getItem()).showNodes(stack, event.getEntityLiving())) {
            ...
            /* 151 */       if (lens != null &&
                    /* 152 */         !player.inventory.addItemStackToInventory(new ItemStack(lens.getItemLens())))
                /* 153 */         player.dropItem(new ItemStack(lens.getItemLens()), false);
            /* 154 */       if (lens2 != null &&
                    /* 155 */         !player.inventory.addItemStackToInventory(new ItemStack(lens.getItemLens()))) {
                /* 156 */         player.dropItem(new ItemStack(lens.getItemLens()), false);
            }
        }
    }
        ...
        if (!entity.world.isRemote) {
            if (entity instanceof IShearable) {
                ...
                if (entity.ticksExisted % 100 == 0 && cap.infusions.containsKey(new ResourceLocation("isorropia:selfshearing")) && shear.isShearable(SHEARS, entity.world, entity.getPosition())) {
                    ArrayList<ItemStack> drops = (ArrayList<ItemStack>)shear.onSheared(SHEARS, entity.world, entity
                            .getPosition(), 0);
...
/* 262 */       .canPlayerEdit(event.getPos().offset(event.getFace()), event.getFace(), stack)) {
            ...
            /* 268 */       if (entityMessage.onValidSurface()) {
                ...
                /* 270 */         world.spawnEntity(entityMessage);
                /* 271 */         stack.shrink(1);
            }
        }
    }
...
/* 284 */         .isPotionActive(MobEffects.WEAKNESS) && !entity.isConverting()) {
                ...
                /* 286 */         if (!knowledge.isResearchKnown("!experiment.villager_zombie")) {
                    ...
                    /* 289 */           ((EntityPlayer)event.getEntity()).sendStatusMessage(new TextComponentString(TextFormatting.DARK_PURPLE +
...
/* 304 */       .hasTagCompound()) {
    ...
    public void onAttack(LivingAttackEvent event) {
        ...
        /* 323 */     if (cap.entityHasOrgan(OrganCurativeInfusionRecipe.Organ.HEART, "isorropia:enderheart") && !base.isEntityInvulnerable(source) && source instanceof net.minecraft.util.EntityDamageSourceIndirect) {
            /* 324 */       base.world.playSound(null, base.prevPosX, base.prevPosY, base.prevPosZ, SoundEvents.ENTITY_ENDERMEN_TELEPORT, base.getSoundCategory(), 1.0F, 1.0F);
