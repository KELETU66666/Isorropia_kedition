...
import fr.wind_blade.isorropia.client.renderer.tiles.*;
...
public class Client
    ...
    public void preInit(FMLPreInitializationEvent event) {
        ...
        ClientRegistry.bindTileEntitySpecialRenderer(TileVatBottom.class, new RenderTileVat());
        ClientRegistry.bindTileEntitySpecialRenderer(TileVat.class, new RenderVatSlave());
        ClientRegistry.bindTileEntitySpecialRenderer(TileSoulBeacon.class, new RenderSoulBeacon());
